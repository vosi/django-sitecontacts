...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contacts.fax'
        db.alter_column('sitecontacts_contacts', 'fax', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Contacts.fax'
        db.alter_column('sitecontacts_contacts', 'fax', self.gf('django.db.models.fields.CharField')(default=0, max_length=255))
    ...
    models = {
        ...
        'sitecontacts.contacts': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 21, 18, 41, 5, 754816)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            ...
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 21, 18, 41, 5, 754991)', 'auto_now': 'True', 'db_index': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
