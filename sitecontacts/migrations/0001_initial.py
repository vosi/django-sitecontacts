...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sitecontacts_contacts', (
            ...
            ('postal_code', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ...
            ('geo_lat', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
            ('geo_long', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 19, 20, 7, 42, 750289), auto_now_add=True, db_index=True, blank=True)),
            ...
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 19, 20, 7, 42, 750468), auto_now=True, db_index=True, auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('sitecontacts', ['Contacts'])


    def backwards(self, orm):
        
        # Deleting model 'Contacts'
        db.delete_table('sitecontacts_contacts')
    ...
    models = {
        ...
        'sitecontacts.contacts': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 20, 7, 42, 750289)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            ...
            'geo_lat': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'geo_long': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locality': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 19, 20, 7, 42, 750468)', 'auto_now': 'True', 'db_index': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'postal_code': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
