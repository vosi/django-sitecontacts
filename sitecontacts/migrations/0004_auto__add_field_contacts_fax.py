...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contacts.fax'
        db.add_column('sitecontacts_contacts', 'fax', self.gf('django.db.models.fields.CharField')(default=0, max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contacts.fax'
        db.delete_column('sitecontacts_contacts', 'fax')
    ...
    models = {
        ...
        'sitecontacts.contacts': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 21, 18, 40, 36, 950674)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            ...
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 21, 18, 40, 36, 950761)', 'auto_now': 'True', 'db_index': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
