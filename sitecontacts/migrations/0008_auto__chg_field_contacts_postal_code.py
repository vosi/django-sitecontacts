...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sitecontacts_contacts', 'postal_code', self.gf('django.db.models.fields.CharField')(max_length=7))
    ...
    models = {
        ...
        'sitecontacts.contacts': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 7, 13, 47, 42, 51992)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            ...
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 7, 13, 47, 42, 52090)', 'auto_now': 'True', 'db_index': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
